...
if [ ! -d "thirdparty/glslang" ]; then
    ...
    cmake thirdparty/glslang -DCMAKE_INSTALL_PREFIX="./install" -B thirdparty/glslang/build -DCMAKE_BUILD_TYPE=Debug -DENABLE_OPT=OFF
...
if [ ! -d "thirdparty/eventpp" ]; then
    ...
    cmake thirdparty/eventpp -DCMAKE_INSTALL_PREFIX="./install" -B thirdparty/eventpp/build -DCMAKE_BUILD_TYPE=Debug
...
#     cmake thirdparty/tracy -DCMAKE_INSTALL_PREFIX="./install" -B thirdparty/tracy/build -DCMAKE_BUILD_TYPE=Debug
# else
#     echo "tracy found"
# fi
...
#     cmake thirdparty/DevIL/DevIL -DCMAKE_INSTALL_PREFIX="./install" -B thirdparty/DevIL/build -DCMAKE_BUILD_TYPE=Debug
...
#     cmake thirdparty/JoltPhysics/Build -DCMAKE_INSTALL_PREFIX="./install" -B thirdparty/JoltPhysics/build -DCMAKE_BUILD_TYPE=Debug
