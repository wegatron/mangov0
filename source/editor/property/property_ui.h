...
enum class EPropertyContainerType { Mono, Array, Map };
...
private:
  ...
  void constructPropertyIntegar(const std::string &name,
  ...
  std::map<EPropertyValueType,
           std::function<void(const std::string &, rttr::variant &)>>
