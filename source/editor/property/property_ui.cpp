...
void PropertyUI::init() {
  ...
  m_property_constructors = {
      {EPropertyValueType::Bool,
       std::bind(&PropertyUI::constructPropertyBool, this,
                 std::placeholders::_1, std::placeholders::_2)},
      {EPropertyValueType::Integar,
       std::bind(&PropertyUI::constructPropertyIntegar, this,
                 std::placeholders::_1, std::placeholders::_2)},
      {EPropertyValueType::Float,
       std::bind(&PropertyUI::constructPropertyFloat, this,
                 std::placeholders::_1, std::placeholders::_2)},
      {EPropertyValueType::String,
       std::bind(&PropertyUI::constructPropertyString, this,
                 std::placeholders::_1, std::placeholders::_2)},
      {EPropertyValueType::Vec2,
       std::bind(&PropertyUI::constructPropertyVec2, this,
                 std::placeholders::_1, std::placeholders::_2)},
      {EPropertyValueType::Vec3,
       std::bind(&PropertyUI::constructPropertyVec3, this,
                 std::placeholders::_1, std::placeholders::_2)},
      {EPropertyValueType::Vec4,
       std::bind(&PropertyUI::constructPropertyVec4, this,
                 std::placeholders::_1, std::placeholders::_2)},
      {EPropertyValueType::Color3,
       std::bind(&PropertyUI::constructPropertyColor3, this,
                 std::placeholders::_1, std::placeholders::_2)},
      {EPropertyValueType::Color4,
       std::bind(&PropertyUI::constructPropertyColor4, this,
                 std::placeholders::_1, std::placeholders::_2)},
      {EPropertyValueType::Asset,
       std::bind(&PropertyUI::constructPropertyAsset, this,
                 std::placeholders::_1, std::placeholders::_2)},
  };

  g_engine.getEventSystem()->addListener(
      EEventType::SelectEntity,
      std::bind(&PropertyUI::onSelectEntity, this, std::placeholders::_1));

  // get dummy texture2d
  m_dummy_image = loadImGuiImageFromImageViewSampler(
      g_engine.assetManager()->getDefaultTexture2D());
}
...
void PropertyUI::construct() {
  ...
  sprintf(m_title_buf, "%s %s###%s", ICON_FA_STREAM,
          (entity_name.empty() ? m_title : entity_name).c_str(),
          m_title.c_str());
...
void PropertyUI::constructEntity(const rttr::instance &instance) {
  ...
  const std::string &type_name =
      p_component != nullptr ? p_component->getTypeName() : "Entity";
  ...
  if (is_tree_open) {
    ...
    for (auto &prop : properties) {
      ...
      ASSERT(property_type.second != EPropertyContainerType::Map,
             "don't support map container property type now");
      ...
      if (property_type.second == EPropertyContainerType::Mono) {
        ...
        for (size_t i = 0; i < view.get_size(); ++i) {
          ...
          m_property_constructors[property_type.first](sub_prop_name,
                                                       sub_variant);
...
void PropertyUI::constructPropertyBool(const std::string &name,
...
void PropertyUI::constructPropertyIntegar(const std::string &name,
                                          rttr::variant &variant) {
  addPropertyNameText(name);
...
void PropertyUI::constructPropertyFloat(const std::string &name,
                                        rttr::variant &variant) {
  addPropertyNameText(name);
...
void PropertyUI::constructPropertyString(const std::string &name,
                                         rttr::variant &variant) {
  addPropertyNameText(name);
...
void PropertyUI::constructPropertyVec2(const std::string &name,
                                       rttr::variant &variant) {
  addPropertyNameText(name);
...
void PropertyUI::constructPropertyVec3(const std::string &name,
                                       rttr::variant &variant) {
  addPropertyNameText(name);
...
void PropertyUI::constructPropertyVec4(const std::string &name,
                                       rttr::variant &variant) {
  addPropertyNameText(name);
...
void PropertyUI::constructPropertyColor3(const std::string &name,
                                         rttr::variant &variant) {
  addPropertyNameText(name);
...
void PropertyUI::constructPropertyColor4(const std::string &name,
                                         rttr::variant &variant) {
  addPropertyNameText(name);
...
void PropertyUI::constructPropertyAsset(const std::string &name,
                                        rttr::variant &variant) {
  ImGui::TableNextColumn();
