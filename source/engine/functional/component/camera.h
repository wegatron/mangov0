...
public:
  ...
  void setExposure(const float aperture, const float shutter_speed, const float sensitivity)
  {
    aperture_ = aperture;
    ...
    ev100_ = std::log2f(aperture_ * aperture_ / shutter_speed_ * 100.0f/sensitivity_);
  }
